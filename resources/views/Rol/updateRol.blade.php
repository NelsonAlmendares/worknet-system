          ...
          <div class="p-4">
            ...
            <div class="mt-5">
                <div class="card container p-3">
                    <h3 class="text-center mb-3">Actualizar Rol</h3>
                    ...
                    <form action="{{ route('Rol.update', $rol->idrol) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="rolname" id="rolname" value="{{ $rol->rolname }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="roldesc" class="form-label">Descripción</label>
                            <input type="text" class="form-control" name="roldesc" id="roldesc" value="{{ $rol->roldesc }}" required>
                        </div>
                            @php
                            $estados = [
                            'A' => 'Activo',
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="rol_e" name="rol_e" required>
                                ...
                                @foreach ($estados as $key => $label)
                                    <option value="{{ $key }}" {{ old('rol_e', $rol->rol_e ?? '') == $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="update-option">
                            <button type="submit" class="btn btn-primary espaciado">Actualizar Rol</button>
                            <a href="{{ route('Rol.index') }}" class="btn btn-secondary espaciado">Cancelar</a>
                        </div>
                    </form>
                </div>
            </div>
