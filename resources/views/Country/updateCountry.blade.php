          ...
          <div class="p-4">
            ...
            <div class="mt-5">
                <div class="card container p-3">
                    ...
                    <form action="{{ route('Country.update', $pais->idcontry) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="contryname" id="contryname" value="{{ $pais->contryname }}" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="contry_e" name="contry_e" required>
                                ...
                                @foreach ($estados as $key => $label)
                                    <option value="{{ $key }}" {{ old('contry_e', $pais->contry_e ?? '') == $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="update-option">
                            <button type="submit" class="btn btn-primary espaciado">Actualizar País</button>
                            <a href="{{ route('Country.index') }}" class="btn btn-secondary espaciado">Cancelar</a>
                        </div>
                    </form>
                </div>
            </div>
