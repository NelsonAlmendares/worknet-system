          ...
          <div class="p-4">
            ...
            <div class="mt-5">
                <div class="card container p-3">
                    ...
                    <form action="{{ route('Department.update', $department->iddepartment) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="deptname" id="deptname" value="{{ $department->deptname }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="dept_idmh" class="form-label">IDMH</label>
                            <input type="text" class="form-control" name="dept_idmh" id="dept_idmh" value="{{ $department->dept_idmh }}" required>
                        </div>
@php
$estados = [
'A' => 'Activo',
...
@endphp
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="dept_e" name="dept_e" required>
                                ...
                                @foreach ($estados as $key => $label)
                                    <option value="{{ $key }}" {{ old('dept_e', $department->dept_e ?? '') == $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="update-option">
                            <button type="submit" class="btn btn-primary espaciado">Actualizar Departamento</button>
                            <a href="{{ route('Department.index') }}" class="btn btn-secondary espaciado">Cancelar</a>
                        </div>
                    </form>
                </div>
            </div>
