...
<div class="d-flex">
    ...
    <div class="main">
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
          ...
          <div class="p-4">
            <h2>Manejo de Departmentos</h2>

            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Departmentos</li>
                </ol>
              </nav>

            <div class="mt-5">
                <div class="card p-3">
                    <h3 class="text-center mb-3">Lista de Departmentos</h3>
                        ...
                        @foreach ($departments as $department)
                            <tr class="text-center">
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('Department.edit', $department->iddepartment) }}" class="btn btn-warning btn-sm">Editar</a>
