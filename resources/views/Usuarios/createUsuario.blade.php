...
<div class="d-flex">
    ...
    <div class="main">
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
          ...
          <div class="p-4">
            <h2 class="greet">Adminisrtación de Usuarios</h2>

            <div class="mt-5">
                <div class="">
                    <h3 class="text-center mb-3">Listado de Usuarios registrados</h3>
                    @if($usuarios->isEmpty())
                    ...
                    <tbody>
                        @foreach ($usuarios as $usuario)
                            <tr class="text-center">
                                ...
                                <td>
                                    <a href="{{ route('Usuarios.edit', $usuario->iduser) }}" class="btn btn-warning btn-sm">
            ...
            <div class="add-center">
                <button type="button" class="btn btn-secondary btn-custom-size fw-bold" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    Agregar usuarios <i class='bx bx-user-pin custom-icon-size' ></i>
                </button>

                <a class="btn btn-dark btn-custom-size fw-bold" href="/generate-pdf?table=usuarios" target="_blank" rel="noopener noreferrer">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('Usuarios.store') }}" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="user_idemp" name="user_idemp" required>
                                                    ...
                                                    @foreach ($empleados as $emp)
                                                        <option value="{{ $emp->idemployee }}" {{ old('user_idemp') == $emp->idemployee ? 'selected' : '' }}>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="user_e" id="user_e" class="form-select" required>
                                                    @foreach ($estados as $key => $label)
                                                        <option value="{{ $key }}" {{ old('user_e') == $key ? 'selected' : '' }}>
                                                            {{ $label }}
                                                        </option>
                                                    @endforeach
                                                </select>
