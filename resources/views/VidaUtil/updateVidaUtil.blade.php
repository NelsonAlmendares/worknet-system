...
<div class="d-flex">
    ...
    <div class="main">
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
          ...
          <div class="p-4">
            <h2>Manejo de Vida Útil</h2>

            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Vida Útil</li>
            ...
            <div class="mt-5">
                <div class="card container p-3">
                    <h3 class="text-center mb-3">Actualizar Vida Útil</h3>

                    <form action="{{ route('VidaUtil.update', $vida->id_vida_util_afd) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="tipo_vida_util_afd" id="tipo_vida_util_afd" value="{{ $vida->tipo_vida_util_afd }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="factor_anual" class="form-label">Factor anual</label>
                            <input type="number" class="form-control" name="factor_anual" id="factor_anual" step="0.01" 
                            min="0" value="{{ number_format($vida->factor_anual, 2) }}" required>
                        </div>
                        <div class="mb-3">
                            ...
                            min="0" value="{{ $vida->plazo_vida_util_afd }}" required>
                        </div>
                        <div class="update-option">
                            <button type="submit" class="btn btn-primary espaciado">Actualizar Vida Útil</button>
                            <a href="{{ route('VidaUtil.index') }}" class="btn btn-secondary espaciado">Cancelar</a>
                        </div>
                    </form>
                </div>
            </div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        @if (Session::has('success'))
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "{{ url('vidaUtil') }}";
            }
        });
        @endif
