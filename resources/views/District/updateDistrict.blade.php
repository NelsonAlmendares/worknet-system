                ...
                <div class="container">
                    ...
                    <form action="{{ route('District.update', $district->iddistrict) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="distname" id="distname" value="{{ $district->distname }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="dist_idmh" class="form-label">IDMH</label>
                            <input type="text" class="form-control" name="dist_idmh" id="dist_idmh" value="{{ $district->dist_idmh }}" required>
                        </div>
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="dist_idmunicipnew" name="dist_idmunicipnew" required>
                                ...
                                @foreach ($municipsnew as $municipnew)
                                    <option value="{{ $municipnew->idmunicipnew }}" {{ old('dist_idmunicipnew', $district->municipNew->idmunicipnew ?? '') == $municipnew->idmunicipnew ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="dist_e" name="dist_e" required>
                                ...
                                @foreach ($estados as $key => $label)
                                    <option value="{{ $key }}" {{ old('dist_e', $district->dist_e ?? '') == $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
